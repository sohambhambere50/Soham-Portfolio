...
const SKILLS = [
  ...
  { name: "Kuberneties", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-original.svg" },
];
...
const ROWS = [
  [
    ...
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git", "GitHub", "VS Code"] },
  ],
  [
    {
      title: "Core Concepts",
